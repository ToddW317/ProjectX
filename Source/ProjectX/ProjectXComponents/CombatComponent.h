...
class PROJECTX_API UCombatComponent : public UActorComponent
{
	GENERATED_BODY()

public:	
	UCombatComponent();
	friend class AProjectXCharacter;
...
private:
	...
	UPROPERTY()
	class AProjectXPlayerController* Controller;

	UPROPERTY()
	class AProjectXHUD* HUD;
